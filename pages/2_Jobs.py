...
for job in st.session_state.jobs:
    ...
    with st.container():
        st.markdown(f"""
        <div style="border:1px solid #e2e8f0; padding:15px; border-radius:10px; margin-bottom:10px; background: white; color: black;">
            <h3 style="color: black;">{job['title']} @ {job['company']}</h3>
